...
const BloodTypes: React.FC = () => {
    ...
    const bloodTypeData = {
        ...
        'O-': {
            ...
            description: 'Nhóm máu hiếm và quý giá nhất, là "người hiến máu toàn năng".',
            characteristics: [
                'Không có kháng nguyên A, B trên hồng cầu',
                'Có kháng thể Anti-A và Anti-B',
                'Không có yếu tố Rh (âm tính)'
            ...
            {Object.entries(bloodTypeData).map(([type, data]) => (
                ...
                >
                    <div className="text-center">
                        ...
                        <div className="text-lg font-semibold text-gray-800">{data.percentage}</div>
                    </div>
                </div>
            ))}
        </div>
        ...
        return (
            <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div>
                        <h4 className="font-semibold text-gray-800 mb-3">Đặc điểm sinh học:</h4>
                    ...
                    <div>
                        <h4 className="font-semibold text-gray-800 mb-3">Thông tin hữu ích:</h4>
                        <ul className="space-y-2">
                        ...
                        <>
                            <div className="text-center mb-8">
                                <p className="text-gray-600 text-lg">
                                    Chọn nhóm máu để xem thông tin chi tiết về khả năng hiến và nhận máu
                                </p>
                            </div>
                            {renderBloodTypeGrid()}

                            <div className="bg-white rounded-lg shadow-lg p-6">
                                <h3 className="text-xl font-bold text-gray-800 mb-4">Thông tin quan trọng</h3>
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        <h4 className="font-semibold text-gray-700 mb-2">Người hiến máu toàn năng:</h4>
                                        <p className="text-gray-600">
                                            Nhóm máu O- có thể hiến cho tất cả các nhóm máu khác, được gọi là "người hiến máu toàn năng".
                                        </p>
                                    </div>
                                    <div>
                                        <h4 className="font-semibold text-gray-700 mb-2">Người nhận máu toàn năng:</h4>
                                        <p className="text-gray-600">
                                            Nhóm máu AB+ có thể nhận máu từ tất cả các nhóm máu khác, được gọi là "người nhận máu toàn năng".
                                        </p>
                                    </div>
                                </div>
                            </div>
